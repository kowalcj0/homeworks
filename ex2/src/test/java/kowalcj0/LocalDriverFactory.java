...
public class LocalDriverFactory {
    public static WebDriver createInstance(String browserName) {
        ...
        switch (Browser.valueOf(browserName.toUpperCase())) {
            case FIREFOX:
                System.setProperty("webdriver.gecko.driver", "binaries/linux/marionette/64bit/geckodriver");
            ...
            case IE:
                ...
                break;
            case CHROME:
                System.setProperty("webdriver.chrome.driver", "binaries/linux/googlechrome/64bit/chromedriver");
